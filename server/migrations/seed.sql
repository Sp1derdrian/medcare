...
('INICIO_SESION'), ('CIERRE_SESION'), ('CREACION_PACIENTE'), 
('EDICION_PACIENTE'), ('CREACION_CITA'), ('CANCELACION_CITA'), 
('COMPLETAR_CITA'), ('CREACION_RECETA'), ('INGRESO_HOSPITALIZACION'), 
('ASIGNACION_ROL'), ('ACTUALIZACION_PERMISOS');
